...
pub struct LineProgram {
    ...
    directories: IndexSet<LineString, BuildHasherDefault<FxHasher>>,
    ...
    files: IndexMap<(LineString, DirectoryId), FileInfo, BuildHasherDefault<FxHasher>>,
...
impl LineProgram {
    ...
    pub fn new(
        ...
        let mut program = LineProgram {
            ...
            encoding,
            line_encoding,
            directories: IndexSet::with_hasher(BuildHasherDefault::default()),
            files: IndexMap::with_hasher(BuildHasherDefault::default()),
    ...
    fn write<W: Writer>(self, w: &mut DebugLine<W>, address_size: u8) -> Result<()> {
        ...
        match self {
            ...
            SetDiscriminator(val) => {
                ...
                let mut writable = BorrowedBuf::from(bytes.as_mut_slice());
                let len = leb128::write::unsigned(writable.unfilled(), val).unwrap();
                w.write_u8(0)?;
