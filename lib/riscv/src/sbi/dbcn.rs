...
/// The physical base address of the input memory is represented by two usize bits wide parameters.
/// The `base_addr_lo` parameter specifies the lower XLEN bits and the `base_addr_hi` parameter specifies the upper XLEN bits
