...
pub struct VolumeDescriptorSet<'a> {
    ...
    pub(crate) _boot: Vec<&'a BootRecord>,
    pub(crate) _supplementary: Vec<&'a SupplementaryVolumeDescriptor>,
    pub(crate) _enhanced: Vec<&'a EnhancedVolumeDescriptor>,
    pub(crate) _volume_partition: Vec<&'a VolumePartitionDescriptor>,
}
