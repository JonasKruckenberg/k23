...
impl<'img, 'a> Directory<'img, 'a> {
    /// Returns the directory identifier as a UTF-8 string.
    ///
    /// # Errors
    ///
    /// Returns [`Utf8Error`] if the identifier contains invalid UTF-8.
    ...
    /// # Errors
    ///
    /// Returns an error if the directory extent is out of bounds.
...
impl<'a> File<'_, 'a> {
    ...
    /// Returns the file identifier as a UTF-8 string.
    ///
    /// # Errors
    ///
    /// Returns [`Utf8Error`] if the identifier contains invalid UTF-8.
    ...
    /// # Errors
    ///
    /// Returns an error if the file extent is out of bounds.
...
impl<'a> DirectoryEntry<'_, 'a> {
    ...
    /// Returns the entry identifier as a UTF-8 string.
    ///
    /// # Errors
    ///
    /// Returns [`Utf8Error`] if the identifier contains invalid UTF-8.
