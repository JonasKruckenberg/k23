...
//
// impl WastContext {
//     pub fn new_default() -> kwasm::Result<Self> {
...
//     }
//
//     pub async fn run(&mut self, path: &str, wat: &str) -> kwasm::Result<()> {
...
//         let inner = self.inner_mut();
//         let module = Module::from_bytes(inner.engine.clone(), &mut inner.validator, module)?;
//
//         Ok(
//             match inner
//                 .linker
