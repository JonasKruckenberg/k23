...
use crate::cranelift::builtins::{BuiltinFunctionSignatures, TrapSentinel};
...
use crate::utils::{array_call_signature, u32_offset_of, value_type, wasm_call_signature};
use crate::vm::{
    StaticVMContextShape, VMArrayCallHostFuncContext, VMCONTEXT_MAGIC, VMFuncRef, VMStoreContext,
};
use crate::wasm::{
...
impl CraneliftCompiler {
    ...
    fn call_builtin(
        ...
        let array_addr = builder.ins().load(
            ...
            mem_flags,
            vmctx,
            i32::from(StaticVMContextShape.vmctx_builtin_functions()),
        );
...
impl Compiler for CraneliftCompiler {
    ...
    fn compile_function(
        ...
        let store_context = context.func.create_global_value(ir::GlobalValueData::Load {
            base: vmctx,
            offset: Offset32::new(i32::from(StaticVMContextShape.vmctx_store_context())),
    ...
    fn compile_array_to_wasm_trampoline(
        ...
        builder.ins().store(
            ...
            vmctx,
            Offset32::new(
                i32::from(StaticVMContextShape.vmctx_store_context())
