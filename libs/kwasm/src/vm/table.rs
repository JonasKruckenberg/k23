...
impl Table {
    pub(super) fn new(elements: Vec<TableElement>, maximum: Option<usize>) -> Self {
    ...
    pub fn fill(&mut self, dst: u64, val: TableElement, len: u64) -> Result<(), TrapKind> {
        ...
        self.elements.as_mut_slice()[start..end].fill(val);
    ...
    fn copy_elements(
        ...
        dst_table.elements.as_mut_slice()[dst_range]
            .copy_from_slice(&src_table.elements.as_slice()[src_range]);
    }
