...
use crate::indices::{
    ...
    FuncRefIndex, GlobalIndex, MemoryIndex, TableIndex, TagIndex,
};
...
use crate::wasm::TranslatedModule;

pub struct StaticVMContextShape;

#[derive(Debug, Clone)]
pub struct VMContextShape {
...
impl VMContextShape {
    pub fn for_module(ptr_size: u8, module: &TranslatedModule) -> Self {
        assert_eq!(ptr_size, StaticVMContextShape.ptr_size());
        ...
        let mut next_field_offset = u32::from(StaticVMContextShape.vmctx_dynamic_data_start());
        ...
        fields! {
            ...
            size(defined_memories)
                = cmul(ret.num_defined_memories, u8_size_of::<VMMemoryDefinition>()),
    ...
    #[inline]
    pub const fn vmctx_magic(&self) -> u8 {
        StaticVMContextShape.vmctx_magic()
    }
    ...
    #[inline]
    pub const fn vmctx_dynamic_data_start(&self) -> u8 {
        StaticVMContextShape.vmctx_dynamic_data_start()
    }
    ...
    pub fn vmctx_vmmemory_definition(&self, index: DefinedMemoryIndex) -> u32 {
        ...
        self.vmctx_memories_begin() + index.as_u32() * u32::from(u8_size_of::<VMMemoryDefinition>())
    }
