...
impl fmt::Write for DebugConsole {
    fn write_str(&mut self, s: &str) -> fmt::Result {
        ...
        // instead of discarding unwritten bytes we simply try again until the buffer is
        // drained.
        while !bytes.is_empty() {
            ...
            // if no bytes were written _at all_ we can assume the firmware DBCN is not
            // accepting any writes. Lets not keep trying.
            if written == 0 {
