...
/// Set up the register state such that we return to the appropriate Wasm
/// error handling place.
fn end_wasm_trap(frame: &mut unwind::Registers, saved: unwind::Registers) {
    *frame = saved;
