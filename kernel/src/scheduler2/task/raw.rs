...
use crate::scheduler2::task::error::JoinError;
use crate::scheduler2::task::id::Id;
use crate::scheduler2::task::state::{
...
impl TaskRef {
    ...
    pub(in crate::scheduler2) fn header_ptr(&self) -> NonNull<Header> {
        self.0
    }
    ...
    S: Schedule,
{
    ...
    unsafe fn try_read_output(ptr: NonNull<Header>, dst: *mut (), waker: &Waker) {
        unsafe {
            let this = Self::from_raw(ptr);
            let dst = &mut *(dst as *mut Poll<task::Result<F::Output>>);
