...
use crate::wasm::{Func, Store, VMVal, Error};
use core::marker::PhantomData;
use core::mem::MaybeUninit;
use core::ptr;
use core::ptr::NonNull;
use crate::wasm::func::{for_each_function_signature, FuncType};
...
pub unsafe trait WasmTy: Send {
    ...
    fn store(self, store: &mut Store, slot: &mut MaybeUninit<VMVal>) -> wasm::Result<()>;
    ...
    Results: WasmResults,
{
    ...
    /// # Safety
    /// 
    /// The caller must make sure that the generic parameters `Params` and `Results` match the types
    /// expected by the WASM function.
    #[inline]
    ...
    fn call_inner(&self, store: &mut Store, params: Params) -> wasm::Result<Results> {
        ...
        unsafe {
            ...
            // we do below.
            {
                ...
                super::do_call(store, func_ref, storage)?;
            }
