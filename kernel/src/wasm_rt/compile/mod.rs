...
use crate::wasm_rt::compile::compiled_function::{RelocationTarget, TrapInfo};
...
use crate::wasm_rt::trap::Trap;
use crate::wasm_rt::Engine;
use alloc::boxed::Box;
...
pub type CompileInput<'a> =
    Box<dyn FnOnce(&dyn Compiler) -> crate::wasm_rt::Result<CompileOutput> + Send + 'a>;
...
impl<'a> CompileInputs<'a> {
    ...
    #[expect(tail_expr_drop_order, reason = "")]
    pub fn compile(self, compiler: &dyn Compiler) -> crate::wasm_rt::Result<UnlinkedCompileOutputs> {
