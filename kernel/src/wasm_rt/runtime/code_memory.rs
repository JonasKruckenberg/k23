...
use crate::wasm_rt::compile::FunctionLoc;
use crate::wasm_rt::runtime::MmapVec;
use crate::wasm_rt::trap::Trap;
use crate::wasm_rt::Error;
use alloc::vec::Vec;
...
impl CodeMemory {
    ...
    pub fn publish(&mut self, aspace: &mut AddressSpace) -> crate::wasm_rt::Result<()> {
