...
use crate::wasm_rt::indices::{DefinedMemoryIndex, DefinedTableIndex};
use crate::wasm_rt::runtime::memory::Memory;
use crate::wasm_rt::runtime::table::Table;
use crate::wasm_rt::runtime::{OwnedVMContext, VMOffsets};
use crate::wasm_rt::translate::{MemoryDesc, TableDesc, TranslatedModule};
use crate::wasm_rt::Module;
use core::mem;
...
pub trait InstanceAllocator {
    ...
    unsafe fn allocate_vmctx(
        ...
        offsets: &VMOffsets,
    ) -> crate::wasm_rt::Result<OwnedVMContext>;
