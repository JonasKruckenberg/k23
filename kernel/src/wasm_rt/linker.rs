...
use crate::wasm_rt::runtime::{ConstExprEvaluator, Imports, InstanceAllocator};
use crate::wasm_rt::translate::EntityType;
use crate::wasm_rt::{Engine, Error, Extern, Instance, Module, Store};
...
impl Linker {
    ...
    fn insert(&mut self, key: ImportKey, item: Extern) -> crate::wasm_rt::Result<()> {
