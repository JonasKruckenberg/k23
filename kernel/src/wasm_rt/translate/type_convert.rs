use crate::wasm_rt::indices::{CanonicalizedTypeIndex, ModuleInternedTypeIndex, TypeIndex};
use crate::wasm_rt::translate::types::{
...
use crate::wasm_rt::translate::{ModuleTypes, TranslatedModule, WasmFuncType, WasmSubType};
use alloc::vec::Vec;
    ...
    pub fn convert_heap_type(&self, ty: wasmparser::HeapType) -> WasmHeapType {
        match ty {
            ...
            wasmparser::HeapType::Abstract { shared, ty } => {
                use crate::wasm_rt::translate::types::WasmHeapTypeInner::*;
