...
use crate::wasm_rt::errors::SizeOverflow;
...
use crate::wasm_rt::{DEFAULT_OFFSET_GUARD_SIZE, WASM32_MAX_SIZE};
use alloc::boxed::Box;
...
// mod tests {
//     use super::*;
//     use crate::wasm_rt::translate::module_translator::ModuleTranslator;
//     use alloc::vec::Vec;
