...
use crate::wasm_rt::translate::module_types::{ModuleTypes, ModuleTypesBuilder};
use crate::wasm_rt::translate::type_convert::WasmparserTypeConverter;
use crate::wasm_rt::translate::types::EntityType;
...
impl<'a, 'data> ModuleTranslator<'a, 'data> {
    ...
    pub fn translate(
        mut self,
        data: &'data [u8],
    ) -> crate::wasm_rt::Result<(ModuleTranslation<'data>, ModuleTypes)> {
    ...
    fn translate_payload(&mut self, payload: Payload<'data>) -> crate::wasm_rt::Result<()> {
        match payload {
            Payload::Version {
                num,
                encoding,
    ...
    fn parse_tag_section(&self, _tags: TagSectionReader<'data>) -> crate::wasm_rt::Result<()> {
