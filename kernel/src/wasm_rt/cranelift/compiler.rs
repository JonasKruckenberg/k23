use crate::arch;
use crate::wasm_rt::builtins::BuiltinFunctionIndex;
use crate::wasm_rt::compile::{CompiledFunction, Compiler, FilePos, NS_WASM_FUNC};
use crate::wasm_rt::cranelift::builtins::BuiltinFunctionSignatures;
use crate::wasm_rt::cranelift::env::TranslationEnvironment;
use crate::wasm_rt::cranelift::func_translator::FuncTranslator;
use crate::wasm_rt::indices::DefinedFuncIndex;
use crate::wasm_rt::runtime::{StaticVMOffsets, VMCONTEXT_MAGIC};
use crate::wasm_rt::translate::{
    FunctionBodyData, ModuleTranslation, ModuleTypes, WasmFuncType, WasmValType,
};
use crate::wasm_rt::trap::{TRAP_EXIT, TRAP_INTERNAL_ASSERT};
use crate::wasm_rt::utils::{array_call_signature, value_type, wasm_call_signature};
use alloc::boxed::Box;
use alloc::vec::Vec;
...
impl Compiler for CraneliftCompiler {
    ...
    fn compile_function(
        ...
        types: &ModuleTypes,
    ) -> crate::wasm_rt::Result<CompiledFunction> {
...
impl FunctionCompiler<'_> {
    ...
    fn finish(mut self, body: Option<&FunctionBody<'_>>) -> crate::wasm_rt::Result<CompiledFunction> {
