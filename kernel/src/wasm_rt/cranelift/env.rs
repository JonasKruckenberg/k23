...
use crate::wasm_rt::compile::NS_WASM_FUNC;
use crate::wasm_rt::cranelift::builtins::BuiltinFunctions;
use crate::wasm_rt::cranelift::code_translator::Reachability;
use crate::wasm_rt::cranelift::memory::CraneliftMemory;
use crate::wasm_rt::cranelift::{CraneliftGlobal, CraneliftTable};
use crate::wasm_rt::indices::{
    CanonicalizedTypeIndex, DataIndex, ElemIndex, FuncIndex, GlobalIndex, MemoryIndex, TableIndex,
    TypeIndex,
};
use crate::wasm_rt::runtime::{VMFuncRef, VMMemoryDefinition, VMOffsets, VMTableDefinition};
use crate::wasm_rt::translate::{
...
use crate::wasm_rt::trap::{TRAP_BAD_SIGNATURE, TRAP_INDIRECT_CALL_TO_NULL, TRAP_NULL_REFERENCE};
use crate::wasm_rt::utils::{reference_type, value_type, wasm_call_signature};
use alloc::vec;
use alloc::vec::Vec;
use core::cmp;
