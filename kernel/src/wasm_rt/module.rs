...
use crate::wasm_rt::compile::{CompileInputs, CompiledFunctionInfo};
use crate::wasm_rt::indices::{DefinedFuncIndex, EntityIndex, VMSharedTypeIndex};
use crate::wasm_rt::runtime::{code_registry, CodeMemory};
use crate::wasm_rt::runtime::{MmapVec, VMOffsets};
use crate::wasm_rt::translate::{Import, TranslatedModule};
use crate::wasm_rt::type_registry::RuntimeTypeCollection;
use crate::wasm_rt::{Engine, ModuleTranslator, Store};
use alloc::sync::Arc;
use core::mem;
...
impl Module {
    ...
    // pub fn from_str(engine: &Engine, validator: &mut Validator, str: &str) -> crate::wasm_rt::Result<Self> {
