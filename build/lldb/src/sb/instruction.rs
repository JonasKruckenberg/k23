...
use crate::{debug_descr, IsValid, SBAddress, SBDataOwned, SBTarget};
...
impl SBInstruction {
    ...
    pub fn mnemonic(&self, target: &SBTarget) -> &str {
        ...
        let ptr = cpp!(unsafe [self as "SBInstruction*", target as "SBTarget"] -> *const ffi::c_char as "const char*" {
