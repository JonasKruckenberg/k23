use crate::{debug_descr, Address, IsValid, SBError};
...
impl<'b> SBData<'b> {
    ...
    pub fn borrow_bytes(bytes: &[u8], endian: ByteOrder, addr_size: usize) -> SBData {
    ...
    pub fn read_string(&self, offset: u64) -> Result<*const ffi::c_char, SBError> {
        let mut error = SBError::new();
        let result = cpp!(unsafe [self as "SBData*", mut error as "SBError", offset as "offset_t"] -> *const ffi::c_char as "const char*" {
