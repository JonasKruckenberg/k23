use crate::{debug_descr, IsValid, LanguageType, SBFileSpec, SBIterator, SBLineEntry};
...
impl SBCompileUnit {
    ...
    pub fn line_entries(&self) -> impl Iterator<Item = SBLineEntry> + '_ {
        SBIterator::new(self.num_line_entries(), move |index| {
            self.line_entry_at_index(index)
        })
    }
